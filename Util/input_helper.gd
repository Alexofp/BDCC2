# Godot-Input-Remapping by Maaack
# https://github.com/Maaack/Godot-Input-Remapping/blob/main/addons/maaacks_input_remapping/base/nodes/utilities/input_helper.gd
...
const MOUSE_BUTTONS : Array = ["None", "Left", "Right", "Middle", "Scroll Up", "Scroll Down", "Wheel Left", "Wheel Right", "Extra Button 1", "Extra Button 2"]
const MOUSE_BUTTONS_FULL : Array = ["None", "Left Mouse Button", "Right Mouse Button", "Middle Mouse Button", "Scroll Up", "Scroll Down", "Mouse Wheel Left", "Mouse Wheel Right", "Extra Mouse Button 1", "Extra Mouse Button 2"]
