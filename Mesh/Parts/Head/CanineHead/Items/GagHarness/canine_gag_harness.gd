...
@onready var ball_gag_module: MeshInstance3D = $Gag/BallGagModule
@onready var ring_gag_module: MeshInstance3D = $Gag/RingGagModule
@onready var bottom_strap: MeshInstance3D = $Gag/BottomStrap
