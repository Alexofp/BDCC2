...
@onready var ball_gag_module: MeshInstance3D = $MascHumanHarnessGag/BallGagModule
@onready var ring_gag_module: MeshInstance3D = $MascHumanHarnessGag/RingGagModule
