...
@onready var feline_mouth: MeshInstance3D = %FelineMouth
...
func grabMaterials():
	...
	mouthMat = feline_mouth.get_surface_override_material(0)
...
func applyOption(_optionID:String, _value:Variant):
	...
	elif(_optionID == "smallMuzzle"):
		setBlendshape("SmallMuzzle", _value)
...
func setHeadMat(_mat:ShaderMaterial):
	_mat = _mat.duplicate()
	$MyHeadRig/Skeleton3D/FelineHead.set_surface_override_material(0, _mat)
