...
@onready var ball_gag_module: MeshInstance3D = $FemHumanHarnessGag/BallGagModule
@onready var ring_gag_module: MeshInstance3D = $FemHumanHarnessGag/RingGagModule
