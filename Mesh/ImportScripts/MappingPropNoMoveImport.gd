...
const Mats:Dictionary[String, String] = {
	MyBigTrim = "res://Mesh/Materials/MyBigTrimSmart.tres",
	MyTrim = "res://Mesh/Materials/MyTrimSmart.tres",
	MyDecals = "res://Mesh/Materials/MyDecalTrimSmart.tres",
	Glass = "res://Mesh/Materials/GlassMat.tres",
	MyFloorTrim = "res://Mesh/Materials/MyFloorTrimSmart.tres",
	ShinyTubeMat = "res://Mesh/Materials/MyPipeMaterial.tres",
	MyConcreteTrim = "res://Mesh/Materials/MyConcreteTrim.tres",
	ConreteTileable4 = "res://Mesh/Textures/Tileable/Concrete031/Concrete031.tres",
	ConreteTileable3 = "res://Mesh/Textures/Tileable/Concrete033/Concrete033.tres",
}
...
func processMeshInstanceMats(node:MeshInstance3D):
	...
	for _i in range(surfaceAmount):
		...
		#mesh.surface_set_material(_i, null)
		
		var foundSomething := false
		for theKey in Mats:
			if(surfaceName.begins_with(theKey)):
				mesh.surface_set_material(_i, load(Mats[theKey]))
				foundSomething = true
				break
