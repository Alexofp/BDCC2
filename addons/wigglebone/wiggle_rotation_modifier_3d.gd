...
# BDCC2 EDIT
@export var enableGravityHelper:bool = false
# END
...
var _global_directionStart := Vector3.UP # Global bone direction.
...
func _process_modification() -> void:
	...
	# Global forces.
	var force := (force_global + properties.get_gravity()*gravScale) * properties.force_scale
...
func _setup() -> void:
	...
	_global_directionStart = _global_direction
