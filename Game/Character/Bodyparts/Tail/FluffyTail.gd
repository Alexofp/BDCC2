...
func generateFor(_gen:CharacterGenerator):
	...
	width = randf_range(0.0, 1.0)
	pickPattern(pattern, _gen, TextureVariantType.TailPattern, "FluffyTail")

func getName() -> String:
	return "Fluffy tail"

func getScenePath(_slot:int) -> String:
	return "res://Mesh/Parts/Tail/FluffyTail/fluffy_tail.tscn"
...
func getTextureVariantsPaths() -> Array:
	return [
		"res://Mesh/Parts/Tail/FluffyTail/Textures/Layers/FluffyTailLayersMany.gd",
	]
