...
const StocksStart = "StocksStart"
const StocksSex = "StocksSex"
const AgainstWallSolo = "AgainstWallSolo"
const AgainstWallSexPinned = "AgainstWallSexPinned"
const AgainstWallSexStart = "AgainstWallSexStart"
